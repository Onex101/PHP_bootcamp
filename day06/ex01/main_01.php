...
$red   = new Colour( array( 'red' => 255, 'green' =>   0, 'blue' =>   0 ) );
$green = new Colour( array( 'red' =>   0, 'green' => 255, 'blue' =>   0 ) );
$blue  = new Colour( array( 'red' =>   0, 'green' =>   0, 'blue' => 255 ) );

$unitX = new Vertex( array( 'x' => 1.0, 'y' => 0.0, 'z' => 0.0, 'colour' => $green ) );
$unitY = new Vertex( array( 'x' => 0.0, 'y' => 1.0, 'z' => 0.0, 'colour' => $red   ) );
$unitZ = new Vertex( array( 'x' => 0.0, 'y' => 0.0, 'z' => 1.0, 'colour' => $blue  ) );
